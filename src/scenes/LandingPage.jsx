    ...
    return (
        ...
        <section id="home" className="md:flex md:justify-between md:items-center gap-16 md:h-full py-10 ml-10">
            ...
            <div className="h-full basis-3/5 mt-16 md:mt-56 flex justify-center md:order-2 mx-16">
                {
                    ...
                    (
                        ...
                        before:w-full before:max-w-[400px] md:before:max-w-[600px] before:h-[40vw] before:border-2 before:border-blue before:z-[-1] mr-14">
                            <img src="../assets/profile-image.jpg" alt="profile image" className="hover:filter hover:saturate-200 transition duration-500 z-10 max-w-[400px] md:max-w-[40vw] rounded-t-[400px]" />
                        </div>
                    ):
                    (
                        <img src="../assets/profile-image.jpg" alt="profile image" className=" z-10 max-w-[525px] mb-6 lg:max-w-[600px]  rounded-t-[400px]" />
                    )
                }
            </div>
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
                ...
                <p className="relative text-6xl md:text-5xl lg:text-6xl font-playfair z-10 text-center md:text-start">Omansh {""}
                <span className="xs:relative xs:text-deep-blue xs:font-semibold z-20 xs:before:content-brush
              before:absolute before:-left-10 before:-top-32 before:md:-top-36 before:lg:-top-32  before:z-[-10] ">Sharma</span></p>
              {/* font-normal font-opensans mt-20 text-xl */}
                <p className="mt-10 mb-7 text-xl text-center md:text-start">Web developer by day, creative problem solver by nature. With a knack for teamwork and a dash of curiosity, I transform challenges into captivating digital experiences.</p>
            </div>
        </section>
     );
}
