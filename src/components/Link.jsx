...
//I am using style to handle when I want some additional styling in links
const Link = ({page, currentPage, setCurrentPage, style}) => {
    ...
    return (
        ...
        href={`#${lcpage}`}
        className={`text-2xl ${fontCol} hover:text-yellow font-poppins py-3 ${style? style:""}`}
